    ...
    public void updateStatistics() {
        try {
            ...
            List<StatisticRow> rows = List.of(
                    ...
                    new StatisticRow("Профит нереализованный (%)", "", NumberFormatter.format(stats.getSumProfitUnrealized())),
