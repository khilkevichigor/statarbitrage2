-- Fix ID column types from INTEGER to BIGINT to match JPA expectations

-- Drop existing tables that were created with INTEGER id types
DROP TABLE IF EXISTS pair_data_long_candles;
DROP TABLE IF EXISTS pair_data_short_candles;
DROP TABLE IF EXISTS pair_data;
DROP TABLE IF EXISTS trade_history;
DROP TABLE IF EXISTS chart_settings;
DROP TABLE IF EXISTS settings;

-- Recreate all tables with proper BIGINT id types
