...
import com.example.core.ui.views.*;
...
public class MainLayout extends AppLayout {
    ...
    private void createDrawer() {
        ...
        nav.addItem(new SideNavItem("Позиции", PositionsView.class, VaadinIcon.MONEY.create()));
