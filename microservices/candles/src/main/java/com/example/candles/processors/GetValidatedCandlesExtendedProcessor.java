//package com.example.candles.processors;
//
...
//public class GetValidatedCandlesExtendedProcessor {
//
...
//
//    public Map<String, Object> process(@RequestBody ExtendedCandlesRequest request) {
