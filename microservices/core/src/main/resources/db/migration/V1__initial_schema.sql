...
(
    ...
    minimum_lot_blacklist                  VARCHAR(1000)    DEFAULT 'ETH-USDT-SWAP,BTC-USDT-SWAP',
    observed_pairs                         VARCHAR(1000)    DEFAULT '',
...
(
    id                  BIGSERIAL PRIMARY KEY,
    chart_type          VARCHAR(255) UNIQUE NOT NULL,
...
(
    ...
    long_ticker                                     VARCHAR(255),
    short_ticker                                    VARCHAR(255),
    ...
    z_score_changes                                 DECIMAL(19, 8),
    long_usdt_changes                               DECIMAL(19, 8),
    long_percent_changes                            DECIMAL(19, 8),
    short_usdt_changes                              DECIMAL(19, 8),
    short_percent_changes                           DECIMAL(19, 8),
    portfolio_before_trade_usdt                     DECIMAL(19, 8),
    profit_usdt_changes                             DECIMAL(19, 8),
    portfolio_after_trade_usdt                      DECIMAL(19, 8),
    profit_percent_changes                          DECIMAL(19, 8),
    minutes_to_min_profit_percent                   BIGINT,
    minutes_to_max_profit_percent                   BIGINT,
    min_profit_percent_changes                      DECIMAL(19, 8),
    max_profit_percent_changes                      DECIMAL(19, 8),
    formatted_time_to_min_profit                    VARCHAR(255),
    formatted_time_to_max_profit                    VARCHAR(255),
    formatted_profit_long                           VARCHAR(255),
    formatted_profit_short                          VARCHAR(255),
    formatted_profit_common                         VARCHAR(255),
    timestamp                                       BIGINT,
    entry_time                                      BIGINT,
    updated_time                                    BIGINT,
    max_z                                           DECIMAL(19, 8),
    min_z                                           DECIMAL(19, 8),
    max_long                                        DECIMAL(19, 8),
    min_long                                        DECIMAL(19, 8),
    max_short                                       DECIMAL(19, 8),
    min_short                                       DECIMAL(19, 8),
    max_corr                                        DECIMAL(19, 8),
    min_corr                                        DECIMAL(19, 8),
    exit_reason                                     VARCHAR(255),
    close_at_breakeven                              BOOLEAN,
    settings_timeframe                              VARCHAR(255),
    ...
    settings_minimum_lot_blacklist                  VARCHAR(255),
...
(
    ...
    open_close_fees         DECIMAL(19, 8),
    open_close_funding_fees DECIMAL(19, 8),
    status                  TEXT,
    open_time               TIMESTAMP,
...
(
    ...
    long_ticker            VARCHAR(255),
    short_ticker           VARCHAR(255),
    pair_uuid              VARCHAR(255),
    min_profit_minutes     VARCHAR(255),
    max_profit_minutes     VARCHAR(255),
    min_profit_percent     DECIMAL(19, 8),
    max_profit_percent     DECIMAL(19, 8),
    current_profit_usdt    DECIMAL(19, 8),
    current_profit_percent DECIMAL(19, 8),
    min_long_percent       DECIMAL(19, 8),
    max_long_percent       DECIMAL(19, 8),
    current_long_percent   DECIMAL(19, 8),
    min_short_percent      DECIMAL(19, 8),
    max_short_percent      DECIMAL(19, 8),
    current_short_percent  DECIMAL(19, 8),
    min_z                  DECIMAL(19, 8),
    max_z                  DECIMAL(19, 8),
