 ...
 */
@Slf4j
@PageTitle("Пары с ошибками")
@Route(value = "error-pairs", layout = MainLayout.class)
public class ErrorPairsView extends VerticalLayout implements UIUpdateable {

    private final TradingPairsComponent tradingPairsComponent;
    private final UIUpdateService uiUpdateService;

    public ErrorPairsView(TradingPairsComponent tradingPairsComponent,
    ...
    private void initializeLayout() {
        add(new H2("Пары с ошибками"));

        // Показываем только закрытые пары
        tradingPairsComponent.showOnlyErrorPairs();
