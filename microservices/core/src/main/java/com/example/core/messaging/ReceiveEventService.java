...
public class ReceiveEventService {
    ...
    //todo при смене ТФ чарты торгуемых пар глючат

    //todo брать не 300 свечей а больше и смотреть экстремумы! по ним понимать какой был максимум по zScore и делать стопы
    //todo чтобы брать более 300 свечей нужно в candles грузить свечи за год в разных ТФ и делать догрузку последних свечей! в итоге в бд будут храниться свечи за год для разных ТФ и разных монет
